...
void main() {
  ...
  group("Github Remote Exchange Source", () {
    test("gets primary exchange rate", () async {
      when(() => client.get(primaryUri)).thenAnswer((_) => Future.value(Response(_primaryData, 200)));
    ...
    test("gets secondary exchange rate if primary fails due to error", () async {
      ...
      when(() => client.get(secondaryUri)).thenAnswer((_) => Future.value(Response(_secondaryData, 200)));
    ...
    test("gets secondary exchange rate if primary fails due to status code", () async {
      when(() => client.get(primaryUri)).thenAnswer((_) => Future.value(Response(_primaryData, 404)));
      when(() => client.get(secondaryUri)).thenAnswer((_) => Future.value(Response(_secondaryData, 200)));
    ...
    test("gets secondary exchange rate if primary fails due to malformed data", () async {
      when(() => client.get(primaryUri)).thenAnswer((_) => Future.value(Response(_malformedData, 200)));
      when(() => client.get(secondaryUri)).thenAnswer((_) => Future.value(Response(_secondaryData, 200)));
    ...
    test("gets secondary exchange rate if primary fails due to missing data", () async {
      when(() => client.get(primaryUri)).thenAnswer((_) => Future.value(Response(_missingData, 200)));
      when(() => client.get(secondaryUri)).thenAnswer((_) => Future.value(Response(_secondaryData, 200)));
    ...
    test("throws if secondary exchange rate fails due to status code", () async {
      when(() => client.get(primaryUri)).thenThrow(StateError("test error"));
      when(() => client.get(secondaryUri)).thenAnswer((_) => Future.value(Response(_secondaryData, 404)));
    ...
    test("throws if secondary exchange rate fails due to malformed data", () async {
      when(() => client.get(primaryUri)).thenThrow(StateError("test error"));
      when(() => client.get(secondaryUri)).thenAnswer((_) => Future.value(Response(_malformedData, 200)));
    ...
    test("throws if secondary exchange rate fails due to missing data", () async {
      when(() => client.get(primaryUri)).thenThrow(StateError("test error"));
      when(() => client.get(secondaryUri)).thenAnswer((_) => Future.value(Response(_missingData, 200)));
