...
void main() {
  group("CC Error", () {
    test("is created from object", () {
      ...
      expect(ccError.code, ErrorCode.source_remote_exchange_invalidCode);
    ...
    test("is printed to string", () {
      ...
      const httpError = CcError(ErrorCode.source_remote_exchange_httpError, message: "test http message");
