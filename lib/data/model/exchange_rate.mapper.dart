...
extension HistorySnapshotPeriodMapperExtension on HistorySnapshotPeriod {
  String toValue() {
    ...
    return MapperContainer.globals.toValue<HistorySnapshotPeriod>(this)
        as String;
  }
}
...
class ExchangeRateSnapshotMapper extends ClassMapperBase<ExchangeRateSnapshot> {
  ...
  static const Field<ExchangeRateSnapshot, DateTime> _f$timestamp =
      Field('timestamp', _$timestamp);
  static Map<CurrencyCode, double> _$exchangeRates(ExchangeRateSnapshot v) =>
      v.exchangeRates;
  static const Field<ExchangeRateSnapshot, Map<CurrencyCode, double>>
      _f$exchangeRates = Field('exchangeRates', _$exchangeRates);
  ...
  static ExchangeRateSnapshot _instantiate(DecodingData data) {
    return ExchangeRateSnapshot(
        data.dec(_f$timestamp), data.dec(_f$exchangeRates));
  }
...
mixin ExchangeRateSnapshotMappable {
  ...
  Map<String, dynamic> toMap() {
    return ExchangeRateSnapshotMapper.ensureInitialized()
        .encodeMap<ExchangeRateSnapshot>(this as ExchangeRateSnapshot);
  }

  ExchangeRateSnapshotCopyWith<ExchangeRateSnapshot, ExchangeRateSnapshot,
          ExchangeRateSnapshot>
      get copyWith => _ExchangeRateSnapshotCopyWithImpl(
          this as ExchangeRateSnapshot, $identity, $identity);
  @override
  String toString() {
    return ExchangeRateSnapshotMapper.ensureInitialized()
        .stringifyValue(this as ExchangeRateSnapshot);
  }

  @override
  bool operator ==(Object other) {
    return ExchangeRateSnapshotMapper.ensureInitialized()
        .equalsValue(this as ExchangeRateSnapshot, other);
  }

  @override
  int get hashCode {
    return ExchangeRateSnapshotMapper.ensureInitialized()
        .hashValue(this as ExchangeRateSnapshot);
  }
}

extension ExchangeRateSnapshotValueCopy<$R, $Out>
    on ObjectCopyWith<$R, ExchangeRateSnapshot, $Out> {
  ExchangeRateSnapshotCopyWith<$R, ExchangeRateSnapshot, $Out>
      get $asExchangeRateSnapshot =>
          $base.as((v, t, t2) => _ExchangeRateSnapshotCopyWithImpl(v, t, t2));
}

abstract class ExchangeRateSnapshotCopyWith<
    $R,
    $In extends ExchangeRateSnapshot,
    $Out> implements ClassCopyWith<$R, $In, $Out> {
  MapCopyWith<$R, CurrencyCode, double, ObjectCopyWith<$R, double, double>>
      get exchangeRates;
  $R call({DateTime? timestamp, Map<CurrencyCode, double>? exchangeRates});
  ExchangeRateSnapshotCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
      Then<$Out2, $R2> t);
}

class _ExchangeRateSnapshotCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, ExchangeRateSnapshot, $Out>
  ...
  @override
  late final ClassMapperBase<ExchangeRateSnapshot> $mapper =
      ExchangeRateSnapshotMapper.ensureInitialized();
  @override
  MapCopyWith<$R, CurrencyCode, double, ObjectCopyWith<$R, double, double>>
      get exchangeRates => MapCopyWith(
          $value.exchangeRates,
          (v, t) => ObjectCopyWith(v, $identity, t),
          (v) => call(exchangeRates: v));
  @override
  $R call({DateTime? timestamp, Map<CurrencyCode, double>? exchangeRates}) =>
  ...
  @override
  ExchangeRateSnapshotCopyWith<$R2, ExchangeRateSnapshot, $Out2>
      $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
          _ExchangeRateSnapshotCopyWithImpl($value, $cast, t);
}

class ExchangeRateHistorySnapshotMapper
    extends ClassMapperBase<ExchangeRateHistorySnapshot> {
  ...
  static ExchangeRateHistorySnapshotMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = ExchangeRateHistorySnapshotMapper._());
      HistorySnapshotPeriodMapper.ensureInitialized();
      CurrencyCodeMapper.ensureInitialized();
    }
    return _instance!;
  ...
  static HistorySnapshotPeriod _$period(ExchangeRateHistorySnapshot v) =>
      v.period;
  static const Field<ExchangeRateHistorySnapshot, HistorySnapshotPeriod>
      _f$period = Field('period', _$period);
  static DateTime _$timestamp(ExchangeRateHistorySnapshot v) => v.timestamp;
  static const Field<ExchangeRateHistorySnapshot, DateTime> _f$timestamp =
      Field('timestamp', _$timestamp);
  static CurrencyCode _$baseCode(ExchangeRateHistorySnapshot v) => v.baseCode;
  static const Field<ExchangeRateHistorySnapshot, CurrencyCode> _f$baseCode =
      Field('baseCode', _$baseCode);
  static CurrencyCode _$convertedCode(ExchangeRateHistorySnapshot v) =>
      v.convertedCode;
  static const Field<ExchangeRateHistorySnapshot, CurrencyCode>
      _f$convertedCode = Field('convertedCode', _$convertedCode);
  static Map<DateTime, double> _$exchangeRates(ExchangeRateHistorySnapshot v) =>
      v.exchangeRates;
  static const Field<ExchangeRateHistorySnapshot, Map<DateTime, double>>
      _f$exchangeRates = Field('exchangeRates', _$exchangeRates);
  ...
  static ExchangeRateHistorySnapshot _instantiate(DecodingData data) {
    return ExchangeRateHistorySnapshot(
        ...
        data.dec(_f$baseCode),
        data.dec(_f$convertedCode),
        data.dec(_f$exchangeRates));
  }
...
mixin ExchangeRateHistorySnapshotMappable {
  String toJson() {
    return ExchangeRateHistorySnapshotMapper.ensureInitialized()
        .encodeJson<ExchangeRateHistorySnapshot>(
            this as ExchangeRateHistorySnapshot);
  }

  Map<String, dynamic> toMap() {
    return ExchangeRateHistorySnapshotMapper.ensureInitialized()
        .encodeMap<ExchangeRateHistorySnapshot>(
            this as ExchangeRateHistorySnapshot);
  }

  ExchangeRateHistorySnapshotCopyWith<ExchangeRateHistorySnapshot,
          ExchangeRateHistorySnapshot, ExchangeRateHistorySnapshot>
      get copyWith => _ExchangeRateHistorySnapshotCopyWithImpl(
          this as ExchangeRateHistorySnapshot, $identity, $identity);
  @override
  String toString() {
    return ExchangeRateHistorySnapshotMapper.ensureInitialized()
        .stringifyValue(this as ExchangeRateHistorySnapshot);
  }
  ...
  int get hashCode {
    return ExchangeRateHistorySnapshotMapper.ensureInitialized()
        .hashValue(this as ExchangeRateHistorySnapshot);
  }
}

extension ExchangeRateHistorySnapshotValueCopy<$R, $Out>
    on ObjectCopyWith<$R, ExchangeRateHistorySnapshot, $Out> {
  ExchangeRateHistorySnapshotCopyWith<$R, ExchangeRateHistorySnapshot, $Out>
      get $asExchangeRateHistorySnapshot => $base
          .as((v, t, t2) => _ExchangeRateHistorySnapshotCopyWithImpl(v, t, t2));
}

abstract class ExchangeRateHistorySnapshotCopyWith<
    $R,
    $In extends ExchangeRateHistorySnapshot,
    $Out> implements ClassCopyWith<$R, $In, $Out> {
  MapCopyWith<$R, DateTime, double, ObjectCopyWith<$R, double, double>>
      get exchangeRates;
  $R call(
  ...
  ExchangeRateHistorySnapshotCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
      Then<$Out2, $R2> t);
}
...
class _ExchangeRateHistorySnapshotCopyWithImpl<$R, $Out>
    ...
    implements
        ExchangeRateHistorySnapshotCopyWith<$R, ExchangeRateHistorySnapshot,
            $Out> {
  _ExchangeRateHistorySnapshotCopyWithImpl(
  ...
  @override
  ExchangeRateHistorySnapshot $make(CopyWithData data) =>
  ...
  @override
  ExchangeRateHistorySnapshotCopyWith<$R2, ExchangeRateHistorySnapshot, $Out2>
      $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
